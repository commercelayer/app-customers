...
1. Fork [this repository](https://github.com/commercelayer/app-customers) (you can learn how to do this [here](https://help.github.com/articles/fork-a-repo)).

2. Clone the forked repository like so:

```bash
git clone https://github.com/<your username>/app-customers.git && cd app-customers
```
